          ...
          >
            ...
            <div className="relative h-48 overflow-hidden">
              ...
              <div className="absolute top-4 right-4 px-3 py-1.5 bg-white/90 backdrop-blur-sm rounded-full shadow-lg">
                <span className="text-sm font-bold text-slate-800">{room.price}</span>
                <span className="text-xs text-slate-500 ml-1">{room.period}</span>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-slate-800">{room.price}</div>
                  </div>
                </div>
      ...
      {rooms.length === 0 && (
        <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
          <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <RoomIcon className="w-8 h-8 text-slate-400" />
          </div>
          <div className="text-slate-500">No rooms found</div>
        </div>
      )}
    </div>
  )
