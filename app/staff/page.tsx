                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-slate-800">{booking.guestName}</div>
                        <div className="text-xs text-slate-500">{booking.email}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-sm text-slate-600 font-medium">{booking.roomType}</span>
                  </td>
                  <td className="px-6 py-4 text-sm text-slate-600">{formatDate(booking.checkIn)}</td>
                  <td className="px-6 py-4 text-sm text-slate-600">{formatDate(booking.checkOut)}</td>
                  <td className="px-6 py-4">
