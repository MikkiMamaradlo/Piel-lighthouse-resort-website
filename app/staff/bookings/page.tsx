    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage and track all guest reservations</p>
        </div>
          ...
          <button
            ...
            className={`group relative px-5 py-2.5 rounded-xl font-medium text-sm transition-all duration-200 ${
              filter === tab.key
                ...
                : "bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600"
            }`}
          >
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
        <div className="p-6 border-b border-slate-100 dark:border-slate-700 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">{filteredBookings.length} bookings found</p>
          </div>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-slate-50 dark:bg-slate-700/50">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Guests</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Status</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Booked</th>
              </tr>
            </thead>
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm">
                    <div className="flex items-center gap-2">
                      <div className="text-slate-600 dark:text-slate-400">{formatDate(booking.checkIn)}</div>
                      ...
                      <div className="text-slate-600 dark:text-slate-400">{formatDate(booking.checkOut)}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
