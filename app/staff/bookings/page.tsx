        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 w-full sm:w-64 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all"
            />
          </div>
        </div>
      </div>
