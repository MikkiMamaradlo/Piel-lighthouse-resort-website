      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2.5 w-full lg:w-80 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all"
          />
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-slate-100">
              ...
              {expandedGuest && (
                <tr className="bg-slate-50 dark:bg-slate-700/50/50">
                      ...
                      <div className="space-y-3">
                        {filteredGuests
                          ...
                          .map((booking) => (
                            <div
                              key={booking._id}
                              className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg hover:bg-slate-100 dark:bg-slate-700 transition-colors"
                            >
