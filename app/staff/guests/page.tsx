  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Guest Information</h1>
          <p className="text-slate-500 mt-1">View and manage guest profiles and booking history</p>
        </div>
        {/* Search */}
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2.5 w-full lg:w-80 border border-slate-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm text-slate-500">With Bookings</div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm text-slate-500">Upcoming Stays</div>
              <div className="text-2xl font-bold text-slate-800">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="p-6 border-b border-slate-100 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">{filteredGuests.length} guests found</p>
          </div>
        </div>
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center">
                        <span className="text-sm font-bold text-slate-600">{guest.totalBookings}</span>
                      </div>
                  ...
                  <td className="px-6 py-4">
                    {guest.upcoming ? (
                      ...
                      <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-full bg-slate-100 text-slate-700 border border-slate-200">
                        No Upcoming
                      </span>
                    )}
                  </td>
        ...
        {filteredGuests.length === 0 && (
          <div className="p-12 text-center">
            <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <GuestsIcon className="w-8 h-8 text-slate-400" />
            </div>
            <div className="text-slate-500">No guests found</div>
            {search && (
              <button
                onClick={() => setSearch("")}
