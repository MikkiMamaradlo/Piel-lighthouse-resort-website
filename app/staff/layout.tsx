...
export default function StaffLayout({
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[var(--secondary)]/20 via-[var(--background)] to-[var(--secondary)]/20 dark:from-[var(--primary)] dark:via-[var(--primary)] dark:to-[var(--primary)]">
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <div className="absolute inset-0 bg-[var(--primary)]/30 dark:bg-[var(--primary)]/50 rounded-2xl blur-xl animate-pulse"></div>
            <div className="relative inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[var(--primary)] to-[var(--secondary)] dark:from-[#42A5F5] dark:to-[#00ACC1] rounded-2xl shadow-lg shadow-[var(--primary)]/30 dark:shadow-[#42A5F5]/50">
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[var(--secondary)]/20 via-[var(--background)] to-[var(--secondary)]/20 dark:from-[var(--primary)] dark:via-[var(--primary)] dark:to-[var(--primary)] bg-[url('/images/piel2.jpg')] bg-cover bg-center bg-fixed bg-no-repeat">
      <div className="min-h-screen bg-white/90 dark:bg-[var(--background)]/90 backdrop-blur-xl">
        {/* Top Navigation */}
        <nav className="fixed top-0 left-0 right-0 h-16 bg-gradient-to-r from-[var(--primary)] via-[var(--primary)] to-[var(--secondary)] dark:from-[#0D47A1] dark:via-[#1565C0] dark:to-[#0D47A1] text-white shadow-lg z-50">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3 pl-6 border-l border-white/20">
                ...
                <div className="hidden sm:block">
                  ...
                  <div className="text-xs text-white/70 dark:text-white/70">{roleDisplayName}</div>
                </div>
                <button
        ...
        <div className="flex pt-16">
          {/* Sidebar */}
          <aside
            className={`fixed left-0 top-16 bottom-0 bg-white/95 dark:bg-[var(--sidebar)]/95 backdrop-blur-2xl shadow-2xl transition-all duration-300 z-40 border-r border-[var(--border)] dark:border-[var(--sidebar-border)] ${
          ...
          >
            <div className="flex flex-col h-full py-6">
              ...
              <div className="px-3 mt-auto">
                <button
                  onClick={() => setIsSidebarCollapsed(!isSidebarCollapsed)}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)] hover:bg-[var(--muted)] dark:hover:bg-[var(--muted)] rounded-xl transition-all duration-300 group"
                >
                  <div className="p-2.5 rounded-xl bg-[var(--muted)] dark:bg-[var(--muted)] group-hover:bg-[var(--secondary)]/20 dark:group-hover:bg-[var(--secondary)]/20 transition-all duration-300">
                    {isSidebarCollapsed ? (
                      <ChevronRight className="w-5 h-5 text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)] transition-transform duration-300" />
                    ) : (
                      <ChevronLeft className="w-5 h-5 text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)] transition-transform duration-300" />
                    )}
                  </div>
