    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
          {/* Profile Header */}
          <div className="p-6 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-slate-100">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-800">{guest?.username || "Guest"}</h2>
                <p className="text-slate-500">{guest?.email || "No email"}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 bg-slate-50 rounded-xl">
                ...
                <p className="font-semibold text-slate-800">{guest?.username || "N/A"}</p>
              </div>
              <div className="p-4 bg-slate-50 rounded-xl">
                <p className="text-sm text-slate-500 mb-1">Email</p>
                <p className="font-semibold text-slate-800">{guest?.email || "N/A"}</p>
              </div>
              <div className="p-4 bg-slate-50 rounded-xl">
                <p className="text-sm text-slate-500 mb-1">Phone</p>
                <p className="font-semibold text-slate-800">{guest?.phone || "Not provided"}</p>
              </div>
              <div className="p-4 bg-slate-50 rounded-xl">
