...
import { Waves, Sun, Anchor } from "lucide-react"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-ocean-900 via-ocean-800 to-ocean-900 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Sun rays */}
        <div className="absolute top-0 left-1/3 w-96 h-96 bg-amber-400/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-40 right-1/4 w-64 h-64 bg-cyan-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "0.5s" }}></div>
      ...
      <div className="relative w-full max-w-lg p-6">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2 text-ocean-200">
            ...
            <span className="text-sm font-medium tracking-wide">Join Our Paradise</span>
            <Sun className="w-4 h-4 text-amber-400 animate-pulse" />
          </div>
        </div>
        ...
        <div className="relative bg-white dark:bg-slate-800/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-slate-500 dark:text-slate-300 text-sm">Start your beach paradise journey today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className={`relative transition-all duration-300 ${
                  ...
                  <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300 ${
                    focusedField === "fullName" ? "text-amber-500" : "text-slate-400 dark:text-slate-300"
                  }`}>
              ...
              <div className="space-y-1">
                ...
                <div className={`relative transition-all duration-300 ${
                  ...
                  <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300 ${
                    focusedField === "email" ? "text-amber-500" : "text-slate-400 dark:text-slate-300"
                  }`}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-1">
                ...
                <div className={`relative transition-all duration-300 ${
                  ...
                  <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300 ${
                    focusedField === "phone" ? "text-amber-500" : "text-slate-400 dark:text-slate-300"
                  }`}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-1">
                ...
                <div className={`relative transition-all duration-300 ${
                  ...
                  <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300 ${
                    focusedField === "password" ? "text-amber-500" : "text-slate-400 dark:text-slate-300"
                  }`}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-1">
                ...
                <div className={`relative transition-all duration-300 ${
                  ...
                  <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300 ${
                    focusedField === "confirmPassword" ? "text-amber-500" : "text-slate-400 dark:text-slate-300"
                  }`}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-1">
                ...
                <div className={`relative transition-all duration-300 ${
                  ...
                  <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300 ${
                    focusedField === "address" ? "text-amber-500" : "text-slate-400 dark:text-slate-300"
                  }`}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 mt-4 bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 hover:from-cyan-600 hover:via-blue-600 hover:to-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0 group"
              >
                {loading ? (
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-300">or</span>
              </div>
            </div>
